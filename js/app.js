...
let articleDetails = document.querySelectorAll('.article-details');
...
document.addEventListener('click',function(e){
  ...
  if(e.target.id === 'share' || e.target.id === 'icon')
  {
    ...
    articleDetails[0].innerHTML = `<div class="social-icons">
    <p class="">SHARE</p>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" class="share-icon">
      <path fill="#FFF"
        d="M15 6.495L8.766.014V3.88H7.441C3.33 3.88 0 7.039 0 10.936v2.049l.589-.612C2.59 10.294 5.422 9.11 8.39 9.11h.375v3.867L15 6.495z" />
    </svg>
  
  </div>`;
  socialIcons[0].style.display = "flex";
  articleContainer.style.paddingBottom = "0";
  }
  ...
  else
  {
    ...
    <div class="author-details">
      <p class="article-author-name">Michelle Appleton</p>
      <p class="article-date">28 Jun 2020</p>
    </div>

    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" class="share-icon" id="share">
      <path fill="#6E8098" id="icon"
        d="M15 6.495L8.766.014V3.88H7.441C3.33 3.88 0 7.039 0 10.936v2.049l.589-.612C2.59 10.294 5.422 9.11 8.39 9.11h.375v3.867L15 6.495z" />
    </svg>
`;

articleDetails[0].style.display = "flex";
articleContainer.style.paddingBottom = "1em";
  }
